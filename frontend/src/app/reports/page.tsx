    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">Overview of performance, alerts, and AI analysis</p>
        </div>
      </div>
      ...
      {!isLoading && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>Summary of language model recommendations on recent alerts</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 text-sm leading-6 text-gray-800 whitespace-pre-wrap">
              {aiInsights || 'AI analysis is not available.'}
            </div>
          </CardContent>
        </Card>
      )}
